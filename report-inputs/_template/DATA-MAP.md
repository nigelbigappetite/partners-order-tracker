# Weekly Report Data Map — week commencing TEMPLATE_WEEK_START_UK
...
## File checklist per site — week commencing TEMPLATE_WEEK_START_UK
...
| `chatham ads-campaigns-list.csv` | available | named "chatham TEMPLATE_WEEK_START_ISO ads-campaigns-list.csv" |
...
| Speed CSVs (4 files) | available | inside `rs-speed-report_TEMPLATE_WEEK_START_UK_TEMPLATE_WEEK_RANGE_UK/` folder |
